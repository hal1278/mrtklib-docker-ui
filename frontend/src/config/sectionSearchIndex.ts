...
const SECTION_SEARCH: Record<string, string[]> = {
  ...
  receiver: [
    'iono compensation', 'isb', 'inter-system bias', 'phase shift', 'max age', 'baseline length',
    ...
    'receiver.iono_correction', 'receiver.isb', 'receiver.phase_shift', 'receiver.max_age',
